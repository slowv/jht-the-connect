...
import { AccountTCComponent } from 'app/entities/account-tc/account-tc.component';
...
describe('Component Tests', () => {
  describe('AccountTC Management Component', () => {
    let comp: AccountTCComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AccountTCComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.accountTCS[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
