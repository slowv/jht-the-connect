...
import { AccountInfoComponent } from 'app/entities/account-info/account-info.component';
...
describe('Component Tests', () => {
  describe('AccountInfo Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.accountInfos[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
